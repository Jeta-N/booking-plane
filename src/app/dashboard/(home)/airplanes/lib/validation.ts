...
export const airplaneFormSchema = z.object({
    ...
    image: z
        .any()
        .refine((file: File) => ACCEPTED_IMAGE_TYPE.includes(file.type), 'Image harus bertipe jpg, jpeg atau png')
        .refine((file: File) => file.size <= MAX_FILE_SIZE, 'Image harus memiliki ukuran maksimal 2MB')
})