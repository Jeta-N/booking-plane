...
import { SEAT_VALUES, type SeatValuesType, dateFormat, rupiahFormat } from '@/lib/utils'
import { useRouter } from 'next/navigation'

interface FlightItemsProps {
    data: FlightWithPlane
}

export default function FlightItem({ data }: FlightItemsProps) {
