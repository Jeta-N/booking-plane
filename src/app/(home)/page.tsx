                        ...
                        <form className="bg-white text-flysha-black w-full flex justify-between items-center rounded-[20px] p-4">
                            <div className="flex gap-[50px] items-center p-4">
                                <div className="flex flex-col justify-center gap-[14px]">
                                    ...
                                    <div className="flex gap-[10px]">
                                        <div className="flex items-center w-8 h-8 shrink-0">
                                            <Image width={120} height={60} src="/assets/images/icons/airplane.svg" alt="icon" />
                                        </div>
                                        <select name="departure" id="departure" className="font-semibold text-[22px] leading-[26.63px] appearance-none bg-[url(/assets/images/icons/arrow-down.svg)] bg-no-repeat bg-[right_1px] pr-[30px]">
                                            ...
                                            {filter?.map((val, key) => (
                                                <option value={val.departureCity} key={`${key} ${val.departureCity}`}>{val.departureCity}</option>
                                            ))}
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col justify-center gap-[14px]">
                                    ...
                                    <div className="flex gap-[10px]">
                                        ...
                                        <select name="arrival" id="arrival" className="font-semibold text-[22px] leading-[26.63px] appearance-none bg-[url(/assets/images/icons/arrow-down.svg)] bg-no-repeat bg-[right_1px] pr-[30px]">
                                            ...
                                            {filter?.map((val, key) => (
                                                <option value={val.destinationCity} key={`${key} ${val.destinationCity}`}>{val.destinationCity}</option>
                                            ))}
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col justify-center gap-[14px]">
                                    ...
                                    <div className="flex gap-[10px]">
                                        <div className="flex items-center w-8 h-8 shrink-0">
                                            <Image width={120} height={60} src="/assets/images/icons/calendar.svg" alt="icon" />
                                        </div>
                ...
                <div className="flex justify-between">
                    <div className="flex flex-col gap-[30px] w-[220px]">
                        <div className="flex shrink-0 w-[70px] h-[70px] rounded-full items-center justify-center bg-flysha-light-purple">
                            <Image height={35} width={35} src="/assets/images/icons/profile-2user.svg" alt="icon" />
                        </div>
                    ...
                    <div className="flex flex-col gap-[30px] w-[220px]">
                        <div className="flex shrink-0 w-[70px] h-[70px] rounded-full items-center justify-center bg-flysha-light-purple">
                            <Image height={35} width={35} src="/assets/images/icons/shield-tick.svg" alt="icon" />
                        </div>
                        <div className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-col gap-[30px] w-[220px]">
                        <div className="flex shrink-0 w-[70px] h-[70px] rounded-full items-center justify-center bg-flysha-light-purple">
                            <Image height={35} width={35} src="/assets/images/icons/crown.svg" alt="icon" />
                        </div>
                        <div className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-col gap-[30px] w-[220px]">
                        <div className="flex shrink-0 w-[70px] h-[70px] rounded-full items-center justify-center bg-flysha-light-purple">
                            <Image height={35} width={35} src="/assets/images/icons/building-3.svg" alt="icon" />
                        </div>
                        <div className="flex flex-col gap-1">
            ...
            <footer className="flex flex-col justify-between mt-[150px] border-t-[6px] border-flysha-light-purple p-[100px_10px_30px]">
                <div className="container max-w-[1130px] mx-auto flex justify-between relative">
                    ...
                    <div className="flex shrink-0 h-fit z-10">
                        <Image height={150} width={150} src="../assets/images/logos/logo.svg" alt="" />
                    </div>
                    <div className="flex gap-[100px] z-10">
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            <Link href="" className="font-medium hover:font-semibold hover:text-flysha-light-purple transition-all duration-300 flex items-center gap-[6px]">
                                <Image height={20} width={20} src="../assets/images/icons/call.svg" alt="icon" />
                                +1 2208 1996
                            </Link>
                            <Link href="" className="font-medium hover:font-semibold hover:text-flysha-light-purple transition-all duration-300 flex items-center gap-[6px]">
                                <Image height={20} width={20} src="../assets/images/icons/dribbble.svg" alt="icon" />
                                buildwithangga
                            </Link>
                            <Link href="" className="font-medium hover:font-semibold hover:text-flysha-light-purple transition-all duration-300 flex items-center gap-[6px]">
                                <Image height={20} width={20} src="../assets/images/icons/sms.svg" alt="icon" />
                                team@bwa.com
                            </Link>
                        </div>
                    </div>
