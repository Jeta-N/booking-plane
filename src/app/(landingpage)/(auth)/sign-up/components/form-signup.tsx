    ...
    return (
        <form action={formAction} className="bg-white text-flysha-black w-[500px] flex flex-col rounded-[20px] gap-5 p-5">
            ...
            <div className="flex flex-col gap-1">
                ...
                <input type="email" name="email" id="email" placeholder="Write your email" className="rounded-full w-full p-[12px_20px] bg-[#EDE8F5] appearance-none outline-none font-semibold ring-2" />
